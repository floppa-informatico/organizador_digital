...
def interface(ventana_principal):
    ...
    pregunta_1 = tk.Label(second_frame, text = "    Para comenzar, ingrese su" 
                    " horario de clases del día Lunes separado por ; (Ej:" 
                    " 9:00-10:00;10:00-11:00;etc.)")
    pregunta_2 = tk.Label(second_frame, text = "Ingrese su horario de clases"
                    " del día Martes seimport tkinter as tk
from tkinter.ttk import Button, Frame, Label
from lib.scrollbar import barra_de_desplazamiento
import sys 
sys.path.append("organizador_digital/proc/")
...
def interface(ventana_principal):
    ...
    pregunta_1 = tk.Label(second_frame, text = "    Para comenzar, ingrese su" 
                    ...
                    " 9:00-10:00;10:00-11:00;etc.)")
    pregunta_2 = tk.Label(second_frame, text = "Ingrese su horario de clases"
                    " del día Martes separado por ; (Ej: 9:00-10:00;"
                    "10:00-11:00;etc.)")
    pregunta_3 = tk.Label(second_frame, text = "Ingrese su horario de clases"
                    " del día Miércoles separado por ; (Ej: 9:00-10:00;"
                    "10:00-11:00;etc.)")
    pregunta_4 = tk.Label(second_frame, text = "Ingrese su horario de clases"
                    " del día Jueves separado por ; (Ej: 9:00-10:00;"
                    "10:00-11:00;etc.)")
    pregunta_5 = tk.Label(second_frame, text = "Ingrese su horario de clases"
                    " del día Viernes separado por ; (Ej: 9:00-10:00;"
                    "10:00-11:00;etc.)")           
    pregunta_6 = tk.Label(second_frame, text = "Ingrese su horario de clases"
                    " del día Sábado separado por ; (Ej: 9:00-10:00;"
                    "10:00-11:00;etc.)") 
    pregunta_7 = tk.Label(second_frame, text = "¿Qué días estudia? Escriba"
                        " los días separado por ; (Ej: viernes;sabado;"
                        "domingo)")
    pregunta_8 = tk.Label(second_frame, text = "¿Cuantas horas le dedicas"
    ...
    pregunta_10 = tk.Label(second_frame, text = "¿Cuantas horas le dedicas a"
                        ...
                        " estructura xx:xx)")
    pregunta_11 = tk.Label(second_frame, text = "¿Como te has sentido?"
                                                " (Escriba bien o mal)")
